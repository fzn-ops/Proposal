...
Penelitian}\label{bab-3-metodologi-penelitian}

\subsection{3.1 Metodologi Data Mining}\label{metodologi-data-mining}

Model CRISP-DM (Cross Industry Standard Process for Data Mining)
merupakan kerangka kerja yang umum digunakan dalam pelaksanaan proyek
data mining karena menyediakan alur kerja yang sistematis dan
terstruktur. Model ini dikembangkan oleh konsorsium industri Eropa pada
akhir tahun 1990-an sebagai standar proses yang dapat diterapkan di
berbagai bidang, baik akademik maupun industri. CRISP-DM terdiri dari
enam tahapan utama yang saling berkaitan, dimulai dari pemahaman
terhadap tujuan bisnis hingga penerapan hasil analisis ke dalam konteks
operasional. Setiap tahap dalam model ini bersifat iteratif, sehingga
peneliti dapat kembali ke tahap sebelumnya apabila hasil yang diperoleh
belum sesuai dengan tujuan yang diharapkan (Wirth \& Hipp, 2000).

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  Business Understanding Tahap Business Understanding berfokus pada
  pemahaman tujuan dan kebutuhan bisnis, kemudian menerjemahkannya
  menjadi permasalahan data mining yang dapat diselesaikan dengan teknik
  analisis data. Pada tahap ini, peneliti perlu menentukan arah dan
  sasaran analisis yang akan dilakukan (Wirth \& Hipp, 2000). Dalam
  proyek ini, tujuan bisnis yang diangkat adalah untuk memahami pola
  pembelian pelanggan pada platform e-commerce agar perusahaan dapat
  melakukan segmentasi pelanggan secara lebih efektif. Peneliti
  mengidentifikasi bahwa perbedaan perilaku pembelian seperti jumlah
  unit yang dibeli, total pendapatan, serta jenis produk yang dibeli
  dapat dijadikan dasar dalam membentuk kelompok pelanggan. Oleh karena
  itu, penelitian ini bertujuan untuk membuat model segmentasi pelanggan
  menggunakan algoritma K-Means Clustering yang dapat mengelompokkan
  pelanggan berdasarkan kesamaan karakteristik transaksi mereka.
\item
  Data Understanding
\end{enumerate}
