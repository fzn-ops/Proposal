...
% Format for chapter/section titles
\usepackage{titlesec}

% Format for chapter/section titles
\titleformat{\section}
  {\centering\Large\bfseries} % Format styling: centered, large size, bold
  {BAB \thesection}           % Prefix with "BAB" and current section number
  {1em}                       % Space between label and title text
  {}                          % Code preceding title body
  [\vspace{1.5cm}]            % Additional space after the title
%% \sectionfont{\normalsize\normalfont\textbf}
%% \subsectionfont{\normalsize\normalfont\textbf}
